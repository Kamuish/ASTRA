...
from ASTRA.utils.paths_tools.file_older_than import file_older_than
from ASTRA.utils.spectral_conditions import KEYWORD_condition
...
class TelfitTelluric(TelluricTemplate):
    """Create Earth's transmittance spectra from TelFit.

    It will be configured with the night with the highest   relative humidity.
    ...
    **User parameters:**
    ...
    def _prepare_GDAS_data(self, dataClass, selected_frame):  # pylint: disable=C0103
        ...
        resources_folder = RESOURCES_PATH / "atmosphere_profiles"
